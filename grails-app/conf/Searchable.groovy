 ...
 * @param appName The Grails application name
 *                Same as application.metadata['app.name']
 * @param appVersion The version of your application
                Same as application.metadata['app.version']
 * @param grailsEnv The Grails environment (ie, "development", "test", "production").
 *                  Same as application.metadata['grails.env']
 *
